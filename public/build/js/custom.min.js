...
function init_flot_chart() {
    ...
    function init_gauge() {
        if ("undefined" != typeof Gauge) {
            ...
            if ($("#gauge-text").length && (t.maxValue = totalI, t.animationSpeed = 20, t.set(totalE), 
                t.setTextField(document.getElementById("gauge-text"))), $("#chart_gauge_02").length) 
                ...
                if ($("#canvas_line3").length) new Chart(document.getElementById("canvas_line3"), {
                    ...
                    if ($("#canvas_line4").length) new Chart(document.getElementById("canvas_line4"), {
                        ...
                        if ($("#mybarChart").length) e = document.getElementById("mybarChart"), new Chart(e, {
                            ...
                            if ($("#mybarChart1").length) e = document.getElementById("mybarChart1"), new Chart(e, {
                                type: "bar",
                                data: {
                                    labels: temasCapacitacion,
                                    datasets: [{
...
function init_echarts() {
    if ("undefined" != typeof echarts) {
        ...
        var e = {
            color: ["#26B99A", "#34495E", "#41A4F7", "#3498DB", "#9B59B6", "#8abb6f", "#759c6a", "#bfd3b7"],
            title: {
                itemGap: 8,
                textStyle: {
                    fontWeight: "normal",
        ...
        if(typeof contFacultad === 'undefined'){
        } else {
         for (var i = 1; i <= contFacultad; i++) {
            if ($("#mainb"+i).length) echarts.init(document.getElementById("mainb"+i), e).setOption({

                tooltip: {
                    trigger: "axis"
                },
                legend: {
                    data: ["Facultad","Género masculino" ,"Género femenino"]
                },
                toolbox: {
                    show: !1
                },
        ...
        if ($("#mainb").length) echarts.init(document.getElementById("mainb"), e).setOption({
            ...
            series: [{
                name: "Facultad",
                type: "bar",
                data:arrayNewPromediosFacultad,
                markPoint: {
                    data: [{
                        type: "max",
                        name: "Nota mínima"
                ...
                name: "Género masculino",
                type: "bar",
                data: promedioFacultadesMasculino,
                markPoint: {
                    data: [{
                        type: "max",
                        name: "Nota máxima"
                ...
                name: "Género femenino",
                type: "bar",
                data: promedioFacultadesFemenino,
                markPoint: {
                    data: [{
                        type: "max",
                        name: "Nota máxima"
            ...
            //////////////////////GRÁFICO PARA CARRERAS/////////////////////////////////
            if ($("#mainbC").length) echarts.init(document.getElementById("mainbC"), e).setOption({

                tooltip: {
                    trigger: "axis"
                },
                legend: {
                    data: ["Carrera", "Género masculino", "Género femenino"]
                },
                toolbox: {
                    show: !1
                },
                ...
                series: [{
                    name: "Carrera",
                    type: "bar",
                    data:arrayNewPromediosCarreras,
                    markPoint: {
                        data: [{
                            type: "max",
                            name: "Nota máxima"
                    ...
                    name: "Género masculino",
                    type: "bar",
                    data: arrayNewPromediosCarrerasM,
                    markPoint: {
                        data: [{
                            type: "max",
                            name: "Nota máxima"
                    ...
                    name: "Género femenino",
                    type: "bar",
                    data: arrayNewPromediosCarrerasF,
                    markPoint: {
                        data: [{
                            type: "max",
                            name: "Nota máxima"
            ...
            //AUTO EVALUACIONES
            if ($("#echart_line1").length) echarts.init(document.getElementById("echart_line1"), e).setOption({
                title: {
                    text: "",
                    subtext: "Subtitle"
                },
...
if ($("#echart_bar_horizontal").length) echarts.init(document.getElementById("echart_bar_horizontal"), e).setOption({
    ...
    legend: {
        x: 100,
        data: ["Total evaluadores", "Masculinos","Femeninos"]
    },
    toolbox: {
        show: !0,
        feature: {
    ...
    //////////////////////////////////////////AUTOEVALUACIÓN////////////////////////////////////////////
    if ($("#echart_bar_horizontalA").length) echarts.init(document.getElementById("echart_bar_horizontalA"), e).setOption({
        ...
        legend: {
            x: 100,
            data: ["Total autoevaluadores", "Masculinos","Femeninos"]
        },
        toolbox: {
            show: !0,
            feature: {
