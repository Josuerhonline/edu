                    ...
                    <div id="login-tab-content" class="active">
                     <form class="login-form" action="<?= route_to("user_login_post")?>" method="POST">
                      ...
                      <div class="form-group" style="width: 30px">
                        <div class="g-recaptcha"  data-sitekey="6LcSmegUAAAAAHSwUeEvSbR2bJDiuVhosdQJpKM9" data-callback="verifyRecaptchaCallback" data-expired-callback="expiredRecaptchaCallback"></div>
    ...
    <script>
      ...
      let onloadCallback = function() {
        widgetId1 = grecaptcha.render('example1', {
          'sitekey' : '6LcSmegUAAAAAHSwUeEvSbR2bJDiuVhosdQJpKM9',
          'theme' : 'dark'
        });
      };
