								...
								<div class="row">
									<div class="col-md-12">
										<div  class="form-group">
											...
											<button type="button" class="btn btn-primary col-md-2 float-right form-control" onclick="procesarCiclo()" id="seleccionarCiclo" style="margin-right: -0.20%;margin-top: 5%;background:#2A3F54">Generar</button>
										</div>
									</div>
								</div>
							</div>
