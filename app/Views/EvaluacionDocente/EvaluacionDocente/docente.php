                ...
                <div class="row">
                  <div class="col-sm-12">
                    <div class="card-box table-responsive">
                     ...
                     ->select('view_carga_academica.*')->where('ciclo',$_SESSION["cicloId"])->where('personaId',$persona)->where('estadoCarga','1')->findAll() ?>
                     <?php if ($cargaData): ?>
                     ...
                     <div class="col-md-4 col-sm-4  profile_details">
                      <div class="well profile_view">
                        <div class="col-sm-12">
                          <h4 class="brief">Auto evaluación docente</h4>
                     ...
                     <?php else : ?>       
                      <h4>No tiene materias asociadas</h4>
                    <?php endif ?>
                  </div>
                </div>
              </div>
