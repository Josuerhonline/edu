...
$EvaluacionResultado = $evaluacionDetalle->selectSum('valor')->where('evaluacionId','18')->first();
$_SESSION["hola"] = $EvaluacionResultado;
			...
			<div class="x_panel" style="border: 1px solid #e1e1e1;" >
				...
				<div class="x_content" style="background: #fff;border: 1px solid #E1E1E1;padding-top: 10px;border-radius: 10px">
					...
					<div class="col-md-4">
						...
						<h2 <?= $rol =='2' ? "hidden" : "" ?>><font color="#172D44">Estudiante:</font><font color="#4b5f71"> <?=  $_SESSION["nombres"];echo " "; echo $_SESSION["apellidos"]; ?></font></h2>
								...
								<div class="row">
									<div class="col-sm-12">
										...
										<div class="x_content">
											...
											<div  hidden="">
												<input type="text" name="aperEvaluacionId" id="aperEvaluacionId" value="<?= $_SESSION["aperEvaluacionId"]?>">
												<input type="text" name="personaId" id="personaId"  value="<?= $_SESSION["personaId"]?>">
												<input type="text" name="planMateriaId" id="planMateriaId"  value="<?= $_SESSION["planMateriaId"]?>">
