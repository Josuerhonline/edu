...
$cargaInscripcionData =  $carga->asObject()
->select('view_carga_academica.*')->where('aperCicloId',$_SESSION["cicloId"])->where('cargaAcademicaId',$inscripcion->cargaAcademicaId)->findAll() ?>

<?php $num=0;  foreach ($cargaInscripcionData as $key => $c): 
$_SESSION["nombresCarga"] = $c->nombresCarga; $_SESSION["apellidosCarga"] = $c->apellidosCarga;$_SESSION["personaId"]=$c->personaId;?>
<?php endforeach ?>
