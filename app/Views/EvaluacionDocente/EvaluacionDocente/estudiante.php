...
<div class="right_col" role="main">
                ...
                <div class="row">
                  <div class="col-sm-12">
                    <div class="card-box table-responsive">
                     ...
                     ->select('view_carga_inscripcion.*')->where('ciclo',$_SESSION["cicloId"])->where('personaId',$persona)->where('aperEvaluacionId',$aperEvaluacionIdResultado)->where('estado','1')->findAll() ?>
                        ...
                        <div class="well profile_view">
                          <div class="col-sm-12">
                            ...
                            <div class="right col-md-5 col-sm-5 text-center">
                              <img src="/user/img/user.png" alt="" class="img-circle img-fluid" style="width: 80%">
                            </div>
                          </div>
                          <div class=" profile-bottom text-center">
                            ...
                            $fechaActual = date("Y-m-d");
                            $aperEvaluacionData =  $aperEvaluacion->asObject()
                            ->select('view_aper_evaluacion.*')->where('ciclo',$_SESSION["cicloId"])->where('fechaInicio<=',$fechaActual)->where('fechaFin>=',$fechaActual)->where('estadoInstrumento','1')->first() ?> 
                            <?php if ($aperEvaluacionData): ?>
                  ...
                  <?php endforeach?>
                  <?php else : ?>       
                    <h4>No hay materias inscritas</h4>
                  <?php endif ?>
                </div>
              </div>
            </div>
 ...
 <?php endif ?>
      <?php if (!$aperEvaluacionData): ?>
     <?php echo "No hay evaluaciones activas" ?>
   <?php endif ?>
</div>
</div>
