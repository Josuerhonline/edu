								...
								<div class="row">
									<div class="col-sm-12">
										...
										<div class="item form-group col-md-11"  <?= !$created ? "hidden" : "" ?> >
												<label class="col-form-label col-md-3 col-sm-3 label-align" for="first-name">Seleccione un plan<span class="required">*</span>
												</label>
												<div class="input-group mb-3 col-md-6">
													...
													<select class="form-control col-md-11" name="planId" id="planId" >
														<?php $num=1; foreach ($plan as $p): ?>
															<option value="<?= $p->planId ?>"><?= $num. ' - '. $p->nombrePlan ?> - Acuerdo: <?= $p->plaAcuerdo ?></option>
