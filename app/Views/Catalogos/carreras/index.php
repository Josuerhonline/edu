                ...
                <div class="row">
                  <div class="col-sm-12">
                    <div class="card-box table-responsive">
                      <a href="/catalogos/carreras/new" title="Crear" class="btn btn-success mb-12" style="margin-left: 19px"><i class="fa fa-plus"></i> Crear</a>
                      <div class="clearfix"></div>
                      ...
                      <tbody>
                       <?php $num=0;  foreach ($carreras as $key => $c): 
                          if ($c->estado =='1'){
                      ...
                      <tr>
                       ...
                       <td>
                        ...
                        <button type="button" class="btn btn-danger" data-toggle="tooltip" data-placement="top" title="Borrar" class="float-right btn btn-danger btn-sm ml-2"  onclick="confirmarBorrar(<?= $c->carreraId ?>)"><i class="fa fa-trash"></i></button>
                      </td>
                    </tr>
                  <?php endforeach?>
                </tbody>
...
<script>
  function confirmarBorrar(id){
    swal({   
      ...
      window.location.href = "/Catalogos/carreras/delete/"+id;
    });
  }
