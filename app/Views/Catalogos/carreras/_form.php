										...
										<form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" >
											...
											<div class="item form-group col-md-11"  <?= !$created ? "hidden" : "" ?> >
												...
												<div class="input-group mb-3 col-md-6">
													<div class="input-group-prepend">
														<span class="input-group-text" id="basic-addon1" style="background: #fff;border-top: #fff;border-left: #fff;border-bottom: #fff;border-right: #fff"><i class="	fa fa-institution" style="color:#2A3F54;width: 20px;height: 24px;
														"></i></span>
													</div>
											...
											<div class="item form-group col-md-11" <?= !$created ? "hidden" : "" ?> >
												...
												<div class="input-group mb-3 col-md-6">
													...
													<input style="width: 79%" class="form-control" value="<?= old('nombre_carrera') ?>" type="text" id="nombre_carrera" name="nombre_carrera"/> 
												</div>
											</div>
											<div class="item form-group col-md-11" <?= !$created ? "hidden" : "" ?> >
												...
												<div class="input-group mb-3 col-md-6">
													<div class="input-group-prepend">
														<span class="input-group-text" id="basic-addon1" style="background: #fff;border-top: #fff;border-left: #fff;border-bottom: #fff;border-right: #fff"><i class="fa fa-pencil" style="color:#2A3F54;width: 20px;height: 24px;
														"></i></span>
													</div>
													<input style="width: 79%" class="form-control"  value="<?= old('nombre_corto') ?>"  type="text" id="nombre_corto" name="nombre_corto"/> 
												</div>
											</div>
											<!-- 	campos para editar -->
											<div class="item form-group col-md-11" <?= $created ? "hidden" : "" ?>>
											...
											<div class="item form-group col-md-11" <?= $created ? "hidden" : "" ?>>
												...
												<div class="input-group mb-3 col-md-6">
													...
													<input style="width: 79%" value="<?=old('nombre_carrera_editar', $carreras->nombre)?>" class="form-control" type="text" id="nombre_carrera_editar" name="nombre_carrera_editar"/> 
												</div>
											</div>
											<div class="item form-group col-md-11" <?= $created ? "hidden" : "" ?>>
												<label class="col-form-label col-md-3 col-sm-3 label-align" for="first-name">Nombre Corto<span class="required">*</span>
												...
												<div class="input-group mb-3 col-md-6">
													...
													<input style="width: 79%" value="<?=old('nombre_corto_editar', $carreras->nombreCorto)?>" class="form-control" type="text" id="nombre_corto_editar" name="nombre_corto_editar"/> 
												</div>
											</div>
											<div class="item form-group col-md-11" <?= $created ? "hidden" : "" ?>>
