	...
	<div class="row" >
		<div class="col-md-12 col-sm-12 " >
			<div class="x_panel" style="border: 1px solid #e1e1e1;" >
				<div class="x_title">
					<button type="button" class="btn btn-primary" onclick="window.location.href='/catalogos/usuario'" style="background: #2A3F54"><i class="fa fa-arrow-left"></i> Regresar</button>
					<div class="clearfix"></div>
				</div>
											...
											<div class="item form-group col-md-12" <?= $created ? "hidden" : "" ?>>
												...
												<div class="input-group mb-3 col-md-6">
													...
													<select class="form-control"  name="estado_editar" id="estado_editar">
														...
														<option <?= $user->estado !== "INACTIVO" ?: "selected"?> value="INACTIVO">INACTIVO</option>
