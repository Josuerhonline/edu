								...
								<div class="row">
									<div class="col-sm-12">
										...
										<div class="item form-group col-md-12" <?= !$created ? "hidden" : "" ?>>
											...
											<div class="input-group mb-3 col-md-6">
												<div class="input-group-prepend">
													<span class="input-group-text" id="basic-addon1"><i class="	fa fa-barcode" style="color:#2A3F54;width: 20px;height: 24px;
													"></i></span>
												</div>
												<input class="form-control" value="<?= old('codMateria') ?>"  type="text" id="codMateria" name="codMateria">
											</div>
										</div>
										<div class="item form-group col-md-12" <?= !$created ? "hidden" : "" ?>>
											...
											<div class="input-group mb-3 col-md-6">
												...
												<input class="form-control" value="<?= old('nombreCorto') ?>" type="text" id="nombreCorto" name="nombreCorto">
											</div>
										</div>

										<!-- 	campos para editar -->
										<div class="item form-group col-md-12" <?= $created ? "hidden" : "" ?>>
											<label class="col-form-label col-md-3 col-sm-3 label-align" for="first-name">materia <span class="required">*</span>
											</label>
											<div class="input-group mb-3 col-md-6">
												<div class="input-group-prepend">
													<span class="input-group-text" id="basic-addon1"><i class="	fa fa-edit" style="color:#2A3F54;width: 20px;height: 24px;
												...
												<input class="form-control" value="<?=old('nombre_editar', $materias->nombre)?>" type="text" id="nombre_editar" name="nombre_editar">
											</div>
										</div>
										<div class="item form-group col-md-12" <?= $created ? "hidden" : "" ?>>
											...
											<div class="input-group mb-3 col-md-6">
												...
												<input class="form-control"  value="<?=old('codMateria_editar', $materias->codMateria)?>" type="text" id="codMateria_editar" name="codMateria_editar">
											</div>
										</div>
										<div class="item form-group col-md-12" <?= $created ? "hidden" : "" ?>>
											<label class="col-form-label col-md-3 col-sm-3 label-align" for="first-name">Nombre corto <span class="required">*</span>
											...
											<div class="input-group mb-3 col-md-6">
												...
												<input class="form-control" value="<?=old('nombreCorto_editar', $materias->nombreCorto)?>" type="text" id="nombreCorto_editar" name="nombreCorto_editar">
											</div>
										</div>
										<div class="item form-group col-md-12" <?= $created ? "hidden" : "" ?>>
