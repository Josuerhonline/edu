									...
									<div class="col-sm-12">
										...
										<div class="item form-group col-md-11" <?= !$created ? "hidden" : "" ?>>
											...
											<div class="input-group mb-3 col-md-6">
												...
												<input style="width: 79%" class="form-control" value="<?= old('area') ?>" type="text" id="area" name="area" >
											</div>
										</div>		
										<!-- 	campos para editar -->
										<div class="item form-group col-md-11" <?= $created ? "hidden" : "" ?>>
											...
											<div class="input-group mb-3 col-md-6">
												...
												<input style="width: 79%" class="form-control" value="<?=old('area_editar', $areas->areaEvaluacion)?>" type="text" id="area_editar" name="area_editar">
											</div>
										</div>
										<div class="item form-group col-md-11" <?= $created ? "hidden" : "" ?>>
